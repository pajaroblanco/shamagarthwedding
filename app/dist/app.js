...
var BaseController = function () {
    ...
    function BaseController($rootScope, $scope, $location, velocity, _, $sce) {
        ...
        this.navLinks = [{ label: 'Destination', smallLabel: $sce.trustAsHtml('<span>Destination</span>'), section: 'destination', isActive: false }, { label: 'Wedding Events', smallLabel: $sce.trustAsHtml('<span>Events</span>'), section: 'mehndi', isActive: false }
